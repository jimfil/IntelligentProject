...
% Slide 3: Wrapper Pipeline Diagram
\begin{frame}{3. Αρχιτεκτονική του Pipeline}
    \begin{figure}
        \centering
...
% Slide 4: Preprocessing and Wrappers
\begin{frame}{4. Προεπεξεργασία και Wrappers}
...
% Slide 5: The 3 Controllers
\begin{frame}{5. Controllers}
    \begin{columns}[t]
...
% Slide 6: Conclusions & Comparison
\begin{frame}{6. Συμπεράσματα \& Συγκριτική Ανάλυση}
    \begin{table}
        \small
        \centering
        \begin{tabular}{lcccc}
...
% Slide 7: Future Work (Behavioral Cloning & Pre-training)
\begin{frame}{7. Μελλοντικές Βελτιώσεις}
	\begin{block}{}
...
% Slide 8: GitHub & Demo Video
\begin{frame}{8. GitHub Repository \& Demo Video}
