...
\begin{frame}{2. Περιβάλλον Προσομοίωσης}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{safety_gymnasium.png}
        \caption{Περιβάλλον Racecar}
    \end{figure}
\end{frame}

% Slide 3: Goal of the Comparison (Baselines vs Safe RL)
\begin{frame}{3. Προσέγγιση \& Baselines Σύγκρισης}
    \begin{block}{Στόχος της Εργασίας}
        Η σύγκριση του μοντέλου μας με 2 baselines.
    \end{block}
    
    \begin{itemize}
        \item \textbf{Baseline 1: Scripted Controller} \\
        
        \item \textbf{Baseline 2: Simple (Unconstrained) PPO} \\
        
        \item \textbf{Safe Navigation: Safe PPO (Lagrangian)} \\
    \end{itemize}
\end{frame}
...
% Slide 5: Wrapper Pipeline Diagram
\begin{frame}{5. Αρχιτεκτονική του Pipeline}
    \begin{figure}
        \centering
        \includegraphics[width=0.95\linewidth]{"Pipeline.png"}
        \caption{Διάγραμμα ροής δεδομένων και εφαρμογής των wrappers}
    \end{figure}
\end{frame}

% Slide 6: Preprocessing and Wrappers
\begin{frame}{6. Προεπεξεργασία και Wrappers}
...
% Slide 7: Conclusions & Comparison
\begin{frame}{7. Συμπεράσματα \& Συγκριτική Ανάλυση}
    \begin{table}
        \small
        \centering
        \begin{tabular}{lcccc}
...
% Slide 8: Future Work (Behavioral Cloning & Pre-training)
\begin{frame}{8. Μελλοντικές Βελτιώσεις}
	\begin{block}{}
...
% Slide 9: GitHub & Demo Video
\begin{frame}{9. GitHub Repository \& Demo Video}
    \begin{block}{GitHub Repository}
        \centering
        \url{https://github.com/jimfil/IntelligentProject}
    \end{block}
    
    \begin{block}{Demo Video (YouTube)}
        \centering
        \url{https://www.youtube.com/watch?v=I0BdkF-7bnI}
    \end{block}
    
    \vspace{0.3cm}
    \begin{itemize}
        \item \textbf{GitHub:} Περιλαμβάνει τον κώδικα των ελεγκτών (Scripted, PPO), Docker configurations και οδηγίες εκτέλεσης.
        \item \textbf{YouTube Video:} Επίδειξη της πλοήγησης του Racecar με τους 3 ελεγκτές (collisions, goal reaching).
    \end{itemize}
\end{frame}
